...
CREATE TABLE public.customers (
    ...
    status public.customer_status DEFAULT 'signed_up'::public.customer_status NOT NULL,
    bio text
);
...
CREATE INDEX customers_bio_index ON public.customers USING gin (to_tsvector('english'::regconfig, bio));
